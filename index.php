...
<section id='main'>
    ...
    <form method='POST' action='Logic.php'>
        ...
        <fieldset>
            ...
            <label>
                <input type='checkbox'
                       name='comic' <?php if (isset($comicCheck) and $comicCheck) echo 'checked' ?> >
                Comic
            </label>
            <label>
                <input type='checkbox'
                       name='book' <?php if (isset($bookCheck) and $bookCheck) echo 'checked' ?> >
                Book
            </label>
            <label>
                <input type='checkbox'
                       name='video' <?php if (isset($videoCheck) and $videoCheck) echo 'checked' ?> >
                Video
            </label>
            <label>
                <input type='checkbox'
                       name='music' <?php if (isset($musicCheck) and $musicCheck) echo 'checked' ?> >
                Music
            </label>
        </fieldset>
                ...
                <ul class='comics'>
					<?php foreach ($comics as $mood => $comic): ?>
                        <li class='comic'>
                            ...
                            <div class='cover'>
                                <img id="comicImg" src='<?= $comic['cover_url'] ?>' alt='Comic image <?= $mood ?>'>
                            </div>
                        </li>
					<?php endforeach ?>
                </ul>
